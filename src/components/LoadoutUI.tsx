  ...
  return (
    ...
    >
      <div className="mc-panel p-6 flex flex-col items-center gap-6 animate-[slideUpFade_0.3s_ease-out_reverse]">
        <h2 className="text-2xl mc-font text-white mc-text-shadow">
          Choose Your Role
        </h2>
        ...
        <div className="flex flex-wrap items-center justify-center gap-6">
          ...
          >
            ...
            <span className="text-white font-bold mc-text-shadow text-lg">
              Painter
            </span>
            <span className="text-zinc-300 text-sm max-w-[120px] text-center">
              Starts with a Fluid Hose
            </span>
          </button>
          ...
          >
            <div className="w-16 h-16 bg-zinc-800 flex items-center justify-center border-2 border-black/50 shadow-inner">
              <span className="text-4xl" style={{ transform: "rotate(45deg)" }}>
                🏹
              </span>
            </div>
            <span className="text-white font-bold mc-text-shadow text-lg">
